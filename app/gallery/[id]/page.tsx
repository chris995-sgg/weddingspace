...
useEffect(() => {
  ...
  <main className="min-h-[100dvh] flex items-start md:items-center justify-center pt-28 md:pt-28 p-6 relative text-black">
      ...
      <div className="max-w-7xl mx-auto">
       ...
       <div className="bg-white/50 backdrop-blur rounded-[2rem] p-8 md:py-5 shadow-2xl border border-white/50">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
          <div className="text-center">
         <h1 className="text-2xl font-bold text-[#3b3128]">
         {eventTitle}
        </h1>
        <p className="mt-2 text-2xl font-semibold text-[#3b3128]">
          Galerie
        </p>
        </div>
